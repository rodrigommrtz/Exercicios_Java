...
public class Ex30_Procedimento_Funcao 
{
    public static void main (String args [])
    {
        ...
        procedimentoAno (ano0, ano1, mes0, mes1, dia0, dia1);
        
    }

        static void procedimentoAno(int ano0, int ano1, int mes0, int mes1, int dia0, int dia1)
        {
        
        int anoT, mesT, diaT;
        int difdias, bis=0; 
            
        funcaoBissexto(ano0, ano1, mes0, mes1, dia0, dia1);
    ...
    static int funcaoBissexto(int ano0, int ano1, int mes0, int mes1, int dia0, int dia1)
    {    
